...
public class CommandUnitOfWork<Tkey> : ICommandUnitOfWork<Tkey>
{
    ...
    public ICategoryCommandRepository CategoryCommand => _categoryCommand ??= new CategoryCommandRepository(_context);

    public IAddressCommandRepository AddressCommand => _addressCommand ??= new AddressCommandRepository(_context);

    public ICartItemCommandRepository CartItemCommand => _cartItemCommand ??= new CartItemCommandRepository(_context);

    public IImageCommandRepository ImageCommand => _imageCommand ??= new ImageCommandRepository(_context);

    public IOrderCommandRepository OrderCommand => _orderCommand ??= new OrderCommandRepository(_context);

    public IOrderItemCommandRepository OrderItemCommand => _orderItemCommand ??= new OrderItemCommandRepository(_context);

    public IProductCommandRepository ProductCommand => _productCommand ??= new ProductCommandRepository(_context);

    public IProductTypeCommandRepository ProductTypeCommand => _productTypeCommand ??= new ProductTypeCommandRepository(_context);

    public IProductVariantCommandRepository ProductVariantCommand => _productVariantCommand ??= new ProductVariantCommandRepository(_context);
