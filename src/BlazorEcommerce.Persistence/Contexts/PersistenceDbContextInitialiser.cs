...
public class PersistenceDbContextInitialiser
{
    ...
    public async Task SeedDataAsync()
    {
        ...
        if (!_context.ProductTypes.Any())
        {
            ...
            {
                new ProductType { Name = "Default" },
                new ProductType { Name = "Paperback" },
                new ProductType { Name = "E-Book" },
                new ProductType { Name = "Audiobook" },
                new ProductType { Name = "Stream" },
                new ProductType { Name = "Blu-ray" },
                new ProductType { Name = "VHS" },
                new ProductType { Name = "PC" },
                new ProductType { Name = "PlayStation" },
                new ProductType { Name = "Xbox" }
            };
